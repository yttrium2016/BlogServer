...
<form id="form" >
    <input type="text" id="inputText" value="500錯誤" />
    <input type="submit" id="btm" value="TRY IT" />
</form>
<script src="http://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
<script src='http://www.jq22.com/demo/jQuery-ztzz20160301/js/EasePack.min.js'></script>
<script src='http://www.jq22.com/demo/jQuery-ztzz20160301/js/TweenLite.min.js'></script>
<script src='http://www.jq22.com/demo/jQuery-ztzz20160301/js/easeljs-0.7.1.min.js'></script>
<script>
    (function() {
        var lastTime = 0;
